 ...
 * @method $this collation(string $collation) Specify a collation for the column (MySQL)
 ...
 * @method $this from(int $startingValue) Set the starting value of an auto-incrementing field (MySQL)
 * @method $this generatedAs(string|Expression $expression = null) Create a SQL compliant identity column
 ...
 * @method $this startingValue(int $startingValue) Set the starting value of an auto-incrementing field (MySQL)
 ...
 */
class ColumnDefinition extends Vivid
{
}